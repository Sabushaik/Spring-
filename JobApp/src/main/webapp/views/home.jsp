...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-clr">
		<div class="container">
			<a class="navbar-brand fs-1 fw-medium " href="#">Shikari Family</a>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link" href="viewalljobs">Places </a></li>
		...
		<div class="row">
			...
			<div class="col-md-6 mb-5">
				<div class="card bg-warning">
					...
					<h5 class="card-title" >		<button type="submit" class="btn btn-primary">Show Guides</button>
						</h5></form>
					</div>
				</div>
			</div>
				...
				<div class="card bg-warning">
					<div class="card-body text-center">
						...
						<form action="/addjob" method="get">
							...
							<h5 class="card-title"> <button type="submit" class="btn btn-primary">Add Guide </button></h5>
						</form>
