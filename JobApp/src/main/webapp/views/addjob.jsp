...
<%@ page isELIgnored="false"%>
	...
	<title>Shikari Web Portal</title>
	<link
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-warning">
			<div class="container">
				<a class="navbar-brand fs-1 fw-medium" href="#">Shikari App</a>
					...
					<div class="card">
						<div class="card-body">
							...
							<form:form action="handleForm" method="post" modelAttribute="jobPost">
								<div class="mb-1">
									<label for="postId" class="form-label">Guide ID</label> <input
										type="text" class="form-control" id="postId" name="postId"
										required>
								</div>
	
								<div class="mb-1">
									<label for="postProfile" class="form-label">Guide Profile</label>
								...
								<div class="mb-1">
									<label for="reqExperience" class="form-label">
										Experience in Field</label> <input type="number" class="form-control"
										id="reqExperience" name="reqExperience" required>
								</div>
	
								<div class="mb-2">
									<label for="postTechStack" class="form-label">Requirements</label>
									<select class="form-select" id="postTechStack"
										name="postTechStack" required multiple>
